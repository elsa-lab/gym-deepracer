...
ctrl+c, ctrl+v from gym_unity:
    https://github.com/Unity-Technologies/ml-agents/blob/master/gym-unity/gym_unity/envs/unity_env.py

'''

class UnityEnvBaseException(error.Error):
    """
...
logger = logging.getLogger("UnityEnvBase")
...
class UnityEnvBase(gym.Env):
    ...
    def _single_step(self, info):
        ...
        return (
            ...
            info.rewards[0],
            info.local_done[0],
            {"text_observation": info.text_observations[0], "brain_info": info, "vector_observations": info.vector_observations[0, :]},
        )
